...
/**
 * parse_input - Parses is being input into individual commands and arguments
 * @input: User input to parse
 * @args: Arguments array
 *
 * Return: Commands and arguments number
 */
...
/**
 * search_command - Searches and executes command
 * @args: Arguments array
 *
 * Return: None
 */
